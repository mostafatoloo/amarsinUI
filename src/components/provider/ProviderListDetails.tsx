...
export const headCells: HeadCell<ProviderDetailTable>[] = [
  ...
  { id: "factorNo", label: "شماره فاکتور", isNumber: true, cellWidth: "5%" ,disableSorting: true,},
  { id: "dat", label: "تاریخ", isNumber: true, cellWidth: "5%" ,disableSorting: true,},
  { id: "customerId", label: "شماره. مشتری", isNumber: true, cellWidth: "5%" ,disableSorting: true,},
  { id: "nId", label: "کد/شناسه ملی", isNumber: true, cellWidth: "5%" ,disableSorting: true,},
  { id: "srName", label: "نام مشتری", cellWidth: "20%" ,disableSorting: true,},
  {
    id: "cupInfoes",
    label: "بچ |انقضاء",
    isNumber: true,
  ...
  { id: "cnt", label: "تعداد", isNumber: true, cellWidth: "5%" ,disableSorting: true,},
  { id: "offerCnt", label: "آفر", isNumber: true, cellWidth: "5%" ,disableSorting: true,},
  { id: "cost", label: "قیمت فروش", isNumber: true, cellWidth: "5%" ,disableSorting: true, isCurrency: true},
  { id: "dcrmnt", label: "تخفیف", isNumber: true, cellWidth: "5%" ,disableSorting: true, isCurrency: true},
  { id: "valueTax", label: "مالیات", isNumber: true, cellWidth: "5%" ,disableSorting: true, isCurrency: true},
  { id: "total", label: "مبلغ", isNumber: true, cellWidth: "5%" ,disableSorting: true, isCurrency: true},
  { id: "shRId", label: "ش. برگه مسیر", isNumber: true, cellWidth: "5%" ,disableSorting: true,},
  { id: "shRDate", label: "ت. برگه مسیر", isNumber: true, cellWidth: "5%" ,disableSorting: true,},
];
